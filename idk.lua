...
-- Функция для создания UI элементов с закруглёнными краями и черным дизайном
...
-- Таблица ключей (пример, расширяй сам до 100)
local keys = {
    ["KEY-001-ABCD"] = true,
    ["KEY-002-EFGH"] = true,
    ["KEY-003-IJKL"] = false, -- выключен
    ["KEY-004-MNOP"] = true,
    ["KEY-005-QRST"] = true,
    -- Добавь сюда ещё ключи...
}
...
-- Главное меню (изменённое по твоему дизайну)
...
-- Начинаем с окна ключа и кнопки Menu
...
-- Закрытие меню — просто скрываем и показываем кнопку Menu
