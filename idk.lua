...
-- Функция для создания рамки с закруглёнными углами
...
local main = createRoundedFrame(ScreenGui, UDim2.new(0, 380, 0, 320), UDim2.new(0.02, 0, 0.6, 0), Color3.fromRGB(30, 30, 30))
main.Visible = false
